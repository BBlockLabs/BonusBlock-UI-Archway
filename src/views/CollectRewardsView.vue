...
import CalculationResultDto from "@/common/api/dto/CalculationResultDto";
...
onMounted(async () => {
  try {
    const response: Array<CalculationResultDto> = await store.dispatch("HttpModule/getCalculationResults");
